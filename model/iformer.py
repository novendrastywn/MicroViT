...
@register_model
def iFormer_t(pretrained=False, pretrained_cfg=False, pretrained_cfg_overlay=False, cache_dir=None, in_22k=False, **kwargs):
    depths = [2, 2, 16, 6]
...
@register_model
def iFormer_s(pretrained=False, pretrained_cfg=False, pretrained_cfg_overlay=False, cache_dir=None, in_22k=False, **kwargs):
    depths = [2, 2, 19, 6]
...
@register_model
def iFormer_m(pretrained=False, pretrained_cfg=False, pretrained_cfg_overlay=False, cache_dir=None, in_22k=False, **kwargs):
    depths = [2, 2, 22, 6]
    block_types = ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 2 + ['ConvBlock_k7_r4'] * 9 + \
...
@register_model
def iFormer_l(pretrained=False, pretrained_cfg=False, pretrained_cfg_overlay=False, cache_dir=None, in_22k=False, **kwargs):
    depths = [2, 2, 33, 6]
