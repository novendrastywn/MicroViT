...
def inference(args, logger):
    ...
    # cfg.val_dataloader.dataset.pipeline=[dict(type='Resize', scale=(1333, 800), keep_ratio=True),
    #                                     dict(type='PackDetInputs', meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape', 'scale_factor'))]
    print(cfg.val_dataloader)
    ...
    mean_flops = _format_size(int(np.average(avg_flops)), 4)
    params = _format_size(params, 4)
